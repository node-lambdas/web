...
},{"base64-js":"../node_modules/base64-js/index.js","ieee754":"../node_modules/ieee754/index.js","isarray":"../node_modules/isarray/index.js","buffer":"../node_modules/buffer/index.js"}],"../node_modules/@homebots/elements/index.js":[function(require,module,exports) {
var global = arguments[3];
...
exports.noop = exports.getInjectorFrom = exports.findParentComponent = exports.domReady = exports.dispatchEvent = exports.defineComponent = exports.createTemplateFromHtml = exports.createComponentInjector = exports.createComponentClass = exports.createComponent = exports.bootstrap = exports.addTemplate = exports.addHostAttributes = exports.ZoneChangeDetector = exports.TemplateRef = exports.TemplateContainer = exports.SealedExecutionContext = exports.ReactiveChangeDetector = exports.Output = exports.NullContext = exports.Input = exports.InjectorSymbol = exports.Injector = exports.Injectable = exports.Inject = exports.ExecutionContext = exports.DomHelpers = exports.DomEventEmitter = exports.ContainerRegistry = exports.Component = exports.Children = exports.Child = exports.ChangeDetectorRef = exports.BOOTSTRAP = exports.ApplicationRef = exports.Application = exports.default = void 0;
...
var utils = createCommonjsModule(function (module, exports) {
  ...
  exports.noop = () => {}; // istanbul ignore next
...
var injector = createCommonjsModule(function (module, exports) {
  ...
  class Injector {
    ...
    has(token, checkParents = true) {
      ...
      if (checkParents && ((_a = this.parent) === null || _a === void 0 ? void 0 : _a.has(token, checkParents))) {
        return true;
      }
...
var syntaxRules = createCommonjsModule(function (module, exports) {
  ...
  SyntaxRules = tslib_es6.__decorate([injector.Injectable()], SyntaxRules);
...
var registry = createCommonjsModule(function (module, exports) {
  ...
  ContainerRegistry = tslib_es6.__decorate([injector.Injectable()], ContainerRegistry);
...
var domHelpers = createCommonjsModule(function (module, exports) {
  ...
  let DomHelpers = class DomHelpers {
    ...
    watchExpressionAndChangeClassName(changeDetector, executionContext, element, property, expression) {
      ...
      changeDetector.watch(valueGetter, value => value ? element.classList.add(className) : element.classList.remove(className));
    }

    addEventListener(changeDetector, executionContext, element, eventNameAndSuffix, expression) {
      const eventHandler = $event => executionContext.run(expression, {
        $event
      });
  ...
  tslib_es6.__decorate([injector.Inject(), tslib_es6.__metadata("design:type", injector.Injector)], DomHelpers.prototype, "injector", void 0);

  tslib_es6.__decorate([injector.Inject(), tslib_es6.__metadata("design:type", syntaxRules.SyntaxRules)], DomHelpers.prototype, "syntaxRules", void 0);

  tslib_es6.__decorate([injector.Inject(), tslib_es6.__metadata("design:type", registry.ContainerRegistry)], DomHelpers.prototype, "containerRegistry", void 0);

  DomHelpers = tslib_es6.__decorate([injector.Injectable()], DomHelpers);
...
var ifContainer = createCommonjsModule(function (module, exports) {
  ...
  tslib_es6.__decorate([inputs.Input(), tslib_es6.__metadata("design:type", Boolean)], IfContainer.prototype, "if", void 0);

  tslib_es6.__decorate([inputs.Input(), tslib_es6.__metadata("design:type", HTMLTemplateElement)], IfContainer.prototype, "else", void 0);

  tslib_es6.__decorate([injector.Inject(), tslib_es6.__metadata("design:type", domHelpers.DomHelpers)], IfContainer.prototype, "dom", void 0);
...
var forContainer = createCommonjsModule(function (module, exports) {
  ...
  tslib_es6.__decorate([inputs.Input(), tslib_es6.__metadata("design:type", Object)], ForContainer.prototype, "of", void 0);

  tslib_es6.__decorate([inputs.Input(), tslib_es6.__metadata("design:type", String)], ForContainer.prototype, "for", void 0);

  tslib_es6.__decorate([injector.Inject(), tslib_es6.__metadata("design:type", domHelpers.DomHelpers)], ForContainer.prototype, "dom", void 0);
...
var executionContext = createCommonjsModule(function (module, exports) {
  ...
  exports.NullContext = exports.SealedExecutionContext = exports.ExecutionContext = void 0;
  const expressionCache = new Map();

  class ExecutionContext {
    constructor(thisValue, parent) {
  ...
  class SealedExecutionContext extends ExecutionContext {
    constructor(parent) {
      super(null, parent);
    }
  ...
  exports.SealedExecutionContext = SealedExecutionContext;
  exports.NullContext = new SealedExecutionContext();
});
unwrapExports(executionContext);
var executionContext_1 = executionContext.NullContext;
var executionContext_2 = executionContext.SealedExecutionContext;
var executionContext_3 = executionContext.ExecutionContext;
var application = createCommonjsModule(function (module, exports) {
  ...
  class Application {
    constructor(rootNode, providers) {
      ...
      injector$1.register({
        type: exports.ApplicationRef,
        useValue: this
      });
      injector$1.register({
        type: executionContext.ExecutionContext,
        useValue: executionContext.NullContext
      });
...
var bootstrap_1 = createCommonjsModule(function (module, exports) {
  ...
  const defaultOptions = {
    ...
    providers: [{
      type: changeDetection.ChangeDetectorRef,
      useValue: new changeDetection.ZoneChangeDetector()
    }]
  };
  ...
  function bootstrap(options) {
    ...
    const changeDetectorProvided = providers.find(p => typeof p !== 'function' && p.type === changeDetection.ChangeDetectorRef);
  ...
  exports.bootstrap = bootstrap; // Thanks @stimulus:
...
var component = createCommonjsModule(function (module, exports) {
  ...
  exports.addHostAttributes = exports.addTemplate = exports.createComponentInjector = exports.findParentComponent = exports.createComponentClass = exports.defineComponent = exports.createComponent = exports.Component = exports.TemplateRef = void 0;
  ...
  function createComponent(options, ComponentClass) {
  ...
  function defineComponent(options, ComponentClass) {
    const CustomElement = createComponent(options, ComponentClass);
  ...
  function createComponentInjector(component, options) {
    ...
    if (!injector$1.has(changeDetection.ChangeDetectorRef, false)) {
      ...
      if (parentChangeDetector) {
        ...
        injector$1.register({
          type: changeDetection.ChangeDetectorRef,
          useClass: changeDetection.ReactiveChangeDetector
        });
      }
    }
  ...
  function addTemplate(target, options) {
    ...
    injector.getInjectorFrom(target).register({
      type: exports.TemplateRef,
      useValue: templateRef
    });

    if (useShadowDom) {
      const shadowDomOptions = options.shadowDom !== true && options.shadowDom || {
        mode: 'open'
      };
...
var component_6 = component.defineComponent;
var component_7 = component.createComponent;
var component_8 = component.Component;
var component_9 = component.TemplateRef;
...
var src = createCommonjsModule(function (module, exports) {
  ...
  Object.defineProperty(exports, "ApplicationRef", {
    enumerable: true,
    get: function () {
      return application.ApplicationRef;
    }
  });
  Object.defineProperty(exports, "bootstrap", {
    enumerable: true,
    get: function () {
      return bootstrap_1.bootstrap;
    }
  });
  Object.defineProperty(exports, "BOOTSTRAP", {
    enumerable: true,
  ...
  Object.defineProperty(exports, "domReady", {
    enumerable: true,
    get: function () {
      return bootstrap_1.domReady;
    }
  });
  Object.defineProperty(exports, "ReactiveChangeDetector", {
    enumerable: true,
    get: function () {
      return changeDetection.ReactiveChangeDetector;
    }
  });
  Object.defineProperty(exports, "ChangeDetectorRef", {
    enumerable: true,
    get: function () {
      return changeDetection.ChangeDetectorRef;
    }
  });
  Object.defineProperty(exports, "ZoneChangeDetector", {
    enumerable: true,
    get: function () {
      return changeDetection.ZoneChangeDetector;
    }
  });
  Object.defineProperty(exports, "addHostAttributes", {
    enumerable: true,
    get: function () {
      return component.addHostAttributes;
    }
  });
  Object.defineProperty(exports, "addTemplate", {
    enumerable: true,
    get: function () {
      return component.addTemplate;
    }
  });
  ...
  Object.defineProperty(exports, "createComponentClass", {
    enumerable: true,
    get: function () {
      return component.createComponentClass;
    }
  });
  Object.defineProperty(exports, "createComponentInjector", {
    enumerable: true,
    get: function () {
      return component.createComponentInjector;
    }
  });
  Object.defineProperty(exports, "findParentComponent", {
    enumerable: true,
    get: function () {
      return component.findParentComponent;
    }
  });
  Object.defineProperty(exports, "TemplateRef", {
    enumerable: true,
    get: function () {
      return component.TemplateRef;
    }
  });
  Object.defineProperty(exports, "ContainerRegistry", {
    enumerable: true,
    get: function () {
      return registry.ContainerRegistry;
    }
  });
  Object.defineProperty(exports, "DomHelpers", {
    enumerable: true,
    get: function () {
      return domHelpers.DomHelpers;
    }
  });
  Object.defineProperty(exports, "Child", {
    enumerable: true,
    get: function () {
      return domHelpers.Child;
    }
  });
  Object.defineProperty(exports, "Children", {
    enumerable: true,
    get: function () {
      return domHelpers.Children;
    }
  });
  Object.defineProperty(exports, "TemplateContainer", {
    enumerable: true,
    get: function () {
      return domHelpers.TemplateContainer;
    }
  });
  Object.defineProperty(exports, "DomEventEmitter", {
    enumerable: true,
    get: function () {
      return events.DomEventEmitter;
    }
  });
  ...
  Object.defineProperty(exports, "SealedExecutionContext", {
    enumerable: true,
    get: function () {
      return executionContext.SealedExecutionContext;
    }
  });
  Object.defineProperty(exports, "NullContext", {
    enumerable: true,
    get: function () {
      return executionContext.NullContext;
    }
  });
  Object.defineProperty(exports, "getInjectorFrom", {
    enumerable: true,
    get: function () {
      return injector.getInjectorFrom;
    }
  });
  ...
  Object.defineProperty(exports, "InjectorSymbol", {
    enumerable: true,
    get: function () {
      return injector.InjectorSymbol;
    }
  });
  ...
  Object.defineProperty(exports, "createTemplateFromHtml", {
    enumerable: true,
    get: function () {
      return utils.createTemplateFromHtml;
    }
  });
...
exports.Application = src_1;
var src_2 = src.ApplicationRef;
exports.ApplicationRef = src_2;
var src_3 = src.bootstrap;
exports.bootstrap = src_3;
var src_4 = src.BOOTSTRAP;
exports.BOOTSTRAP = src_4;
var src_5 = src.domReady;
exports.domReady = src_5;
var src_6 = src.ReactiveChangeDetector;
exports.ReactiveChangeDetector = src_6;
var src_7 = src.ChangeDetectorRef;
exports.ChangeDetectorRef = src_7;
var src_8 = src.ZoneChangeDetector;
exports.ZoneChangeDetector = src_8;
var src_9 = src.addHostAttributes;
exports.addHostAttributes = src_9;
var src_10 = src.addTemplate;
exports.addTemplate = src_10;
var src_11 = src.Component;
exports.Component = src_11;
var src_12 = src.defineComponent;
exports.defineComponent = src_12;
var src_13 = src.createComponent;
exports.createComponent = src_13;
var src_14 = src.createComponentClass;
exports.createComponentClass = src_14;
var src_15 = src.createComponentInjector;
exports.createComponentInjector = src_15;
var src_16 = src.findParentComponent;
exports.findParentComponent = src_16;
var src_17 = src.TemplateRef;
exports.TemplateRef = src_17;
var src_18 = src.ContainerRegistry;
exports.ContainerRegistry = src_18;
var src_19 = src.DomHelpers;
exports.DomHelpers = src_19;
var src_20 = src.Child;
exports.Child = src_20;
var src_21 = src.Children;
exports.Children = src_21;
var src_22 = src.TemplateContainer;
exports.TemplateContainer = src_22;
var src_23 = src.DomEventEmitter;
exports.DomEventEmitter = src_23;
var src_24 = src.Output;
exports.Output = src_24;
var src_25 = src.dispatchEvent;
exports.dispatchEvent = src_25;
var src_26 = src.ExecutionContext;
exports.ExecutionContext = src_26;
var src_27 = src.SealedExecutionContext;
exports.SealedExecutionContext = src_27;
var src_28 = src.NullContext;
exports.NullContext = src_28;
var src_29 = src.getInjectorFrom;
exports.getInjectorFrom = src_29;
var src_30 = src.Inject;
exports.Inject = src_30;
var src_31 = src.Injectable;
exports.Injectable = src_31;
var src_32 = src.Injector;
exports.Injector = src_32;
var src_33 = src.InjectorSymbol;
exports.InjectorSymbol = src_33;
var src_34 = src.Input;
exports.Input = src_34;
var src_35 = src.createTemplateFromHtml;
exports.createTemplateFromHtml = src_35;
var src_36 = src.noop;
exports.noop = src_36;
var _default = index;
exports.default = _default;
},{"buffer":"../node_modules/buffer/index.js"}],"../node_modules/@node-lambdas/client/dist/index.js":[function(require,module,exports) {
"use strict";
...
function t(t) {
  const n = t.options || {},
        o = t.local ? "" : t.name,
        r = t.action || "",
        c = (t.local ? "http://" : "https://") + o + (t.local ? "localhost" : ".jsfn.run") + (t.local && t.port ? ":" + t.port : "") + "/" + r + "?" + String(new URLSearchParams(Object.entries(Object(n))));
  let i;

  if (t.credentials) {
    const e = btoa(JSON.stringify(t.credentials));
    i = {
...
function e(t) {
  return t.ok ? t : Promise.reject(t.text());
}

function n(e, ...n) {
  return n.reduce((e, n) => function (e, n) {
    return r(e).then(o).then(t(n));
  }(e, n), r(e));
}

function o(t) {
  return t instanceof Blob ? t : t.blob();
}

function r(t) {
  return t instanceof Promise ? t : Promise.resolve(t);
}
},{}],"app/app.component.htm":[function(require,module,exports) {
module.exports = "<section class=\"py-6\">\n  <textarea\n    autofocus\n    name=\"input\"\n    data-id=\"stdin\"\n    placeholder=\"input\"\n    class=\"border border-gray-400 border-solid bg-gray-100 w-full h-20 p-2 text-blue-800 font-mono p-2\"\n  ></textarea>\n\n  <hr class=\"mt-4 mb-5 border-orange-400\" />\n\n  <form (submit.stop)=\"this.run()\" action>\n    <template *for=\"'item'\" [of]=\"this.steps\">\n      <x-step [step]=\"item\" (remove)=\"this.removeStep(index)\" class=\"flex-grow\"></x-step>\n    </template>\n  </form>\n  <div class=\"flex w-full bg-gray justify-between py-5\">\n    <div class=\"btn-group\">\n      <button\n        (click)=\"this.addStep()\"\n        type=\"button\"\n        class=\"border-gray-400 border-solid bg-orange-400 text-orange-900 rounded py-1 px-5\"\n      >\n        add step\n      </button>\n      <button\n        (click)=\"this.reset()\"\n        type=\"button\"\n        class=\"border border-orange-400 border-solid bg-white text-orange-900 rounded py-1 px-5\"\n      >\n        reset\n      </button>\n    </div>\n    <button\n      (click)=\"this.run()\"\n      type=\"submit\"\n      class=\"border-gray-400 border-solid bg-orange-400 text-orange-900 rounded py-1 px-5 disabled:bg-gray-400\"\n      [disabled]=\"!this.valid\"\n    >\n      run\n    </button>\n  </div>\n\n  <hr class=\"mt-4 mb-5 border-orange-400\" />\n\n  <template *if=\"!!this.stdout\">\n    <div\n      [innertext]=\"this.stdout\"\n      class=\"border border-gray-400 border-solid bg-gray-100 w-full font-mono p-4 rounded\"\n    ></div\n  ></template>\n  <template *if=\"!!this.stderr\">\n    <div\n      [innertext]=\"this.stderr\"\n      class=\"border border-orange-400 border-solid bg-gray-100 w-full text-orange-400 font-mono p-4 rounded\"\n    ></div>\n  </template>\n</section>\n"
},{}],"app/app.component.ts":[function(require,module,exports) {
"use strict";
...
var _elements = require("@homebots/elements");

var _client = require("@node-lambdas/client");

var _appComponent = _interopRequireDefault(require("./app.component.htm"));
...
let AppComponent = class AppComponent extends HTMLElement {
  ...
  onInit() {
    this.stdinRef.value = JSON.stringify({
      number: 42
    });
    const steps = [{}];
  ...
  async run() {
    try {
      this.stdout = await (await (0, _client.pipe)(this.stdin, ...this.steps)).text();
      this.stderr = null;
    } catch (error) {
...
__decorate([(0, _elements.Child)('[data-id="stdin"]'), __metadata("design:type", typeof (_a = typeof HTMLTextAreaElement !== "undefined" && HTMLTextAreaElement) === "function" ? _a : Object)], AppComponent.prototype, "stdinRef", void 0);

__decorate([(0, _elements.Inject)(_elements.ChangeDetectorRef), __metadata("design:type", typeof (_b = typeof _elements.ChangeDetector !== "undefined" && _elements.ChangeDetector) === "function" ? _b : Object)], AppComponent.prototype, "cd", void 0);

exports.AppComponent = AppComponent = __decorate([(0, _elements.Component)({
  tag: 'x-app',
  template: _appComponent.default,
  shadowDom: false
})], AppComponent);
},{"@homebots/elements":"../node_modules/@homebots/elements/index.js","@node-lambdas/client":"../node_modules/@node-lambdas/client/dist/index.js","./app.component.htm":"app/app.component.htm"}],"step/step.component.htm":[function(require,module,exports) {
module.exports = "<div\n  class=\"flex justify-between items-start rounded my-2 border-b border-gray-400 border-solid p-2 font-mono flex justify-start\"\n>\n  <span class=\"py-2 px-4 text-gray-500\">fn</span>\n  <div class=\"w-1/3 flex\">\n    <input\n      class=\"bg-transparent w-1/2 text-orange-400 p-2 border-b border-solid border-gray-400 mr-4\"\n      placeholder=\"function\"\n      [value]=\"this.step.name\"\n      (input)=\"this.step.name = $event.target.value\"\n    />\n    <input\n      placeholder=\"action\"\n      class=\"bg-transparent w-1/2 text-orange-400 p-2 border-b border-solid border-gray-400\"\n      (input)=\"this.step.action = $event.target.value\"\n    />\n  </div>\n  <div class=\"w-2/3 flex-grow\">\n    <template *for=\"'option'\" [of]=\"this.options\">\n      <div class=\"flex items-center px-4\">\n        <span class=\"px-2 text-gray-500\">--</span>\n        <input\n          placeholder=\"option=value\"\n          type=\"text\"\n          class=\"bg-transparent text-orange-400 p-2 flex-grow border-b border-solid border-gray-400\"\n          [value]=\"option\"\n          (change)=\"this.updateOption(index, $event.target.value);\"\n        />\n      </div>\n    </template>\n  </div>\n  <div class=\"flex items-center py-1\">\n    <button\n      (click)=\"this.addOption()\"\n      class=\"border-gray-400 border-solid bg-gray-400 text-gray-600 rounded py-1 px-2 mr-4\"\n      type=\"button\"\n    >\n      +\n    </button>\n    <input type=\"checkbox\" @id=\"'local' + this.uid\" (change)=\"this.step.local = $event.target.checked\" />\n    <label class=\"pl-2 pr-4\" @for=\"'local' + this.uid\">+local </label>\n    <label class=\"pl-2 pr-4\" @for=\"'local' + this.uid\">+port=</label>\n    <input\n      type=\"number\"\n      class=\"bg-transparent text-orange-400 py-2 px-2 border-b border-solid border-gray-400 w-24\"\n      (input)=\"this.step.port = $event.target.value\"\n    />\n  </div>\n  <button (click)=\"this.onRemove.emit()\" class=\"px-4 py-2 text-red-600 text-xl\" type=\"button\">&times;</button>\n</div>\n"
},{}],"step/step.component.ts":[function(require,module,exports) {
"use strict";
...
var _stepComponent = _interopRequireDefault(require("./step.component.htm"));
...
let StepComponent = class StepComponent extends HTMLElement {
  constructor() {
    super(...arguments);
    this.options = [''];
    this.uid = String(~~Math.random() * 2);
  }
  ...
  updateOption(index, value) {
    ...
    this.step.options = this.options.filter(Boolean).reduce((options, pair) => {
...
__decorate([(0, _elements.Input)(), __metadata("design:type", typeof (_a = typeof _client.RunOptions !== "undefined" && _client.RunOptions) === "function" ? _a : Object)], StepComponent.prototype, "step", void 0);

__decorate([(0, _elements.Output)('remove'), __metadata("design:type", typeof (_b = typeof _elements.EventEmitter !== "undefined" && _elements.EventEmitter) === "function" ? _b : Object)], StepComponent.prototype, "onRemove", void 0);

exports.StepComponent = StepComponent = __decorate([(0, _elements.Component)({
  tag: 'x-step',
  template: _stepComponent.default,
  shadowDom: false
})], StepComponent);
},{"@homebots/elements":"../node_modules/@homebots/elements/index.js","@node-lambdas/client":"../node_modules/@node-lambdas/client/dist/index.js","./step.component.htm":"step/step.component.htm"}],"index.ts":[function(require,module,exports) {
"use strict";
...
Object.defineProperty(exports, "AppComponent", {
  enumerable: true,
  get: function () {
    return _app.AppComponent;
  }
});
Object.defineProperty(exports, "StepComponent", {
  enumerable: true,
  get: function () {
    return _step.StepComponent;
  }
});
...
var _step = require("./step/step.component");
...
function debounce(time = 100) {
  return (target, name, descriptor) => {
    ...
    descriptor = { ...descriptor,
      value: debounceTime(fn, time)
    };
    Object.defineProperty(target, name, descriptor);
  };
}

class CheckTreeDetector extends _elements.ReactiveChangeDetector {
  fork(target) {
  ...
  _checkTree() {
    this.check();
    this.children.forEach(cd => cd._checkTree());
  }

}

__decorate([debounce(), __metadata("design:type", Function), __metadata("design:paramtypes", []), __metadata("design:returntype", void 0)], CheckTreeDetector.prototype, "checkTree", null);

(0, _elements.bootstrap)({
  providers: [{
    type: _elements.ChangeDetectorRef,
    useClass: CheckTreeDetector
  }]
});
},{"@homebots/elements":"../node_modules/@homebots/elements/index.js","./app/app.component":"app/app.component.ts","./step/step.component":"step/step.component.ts"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
